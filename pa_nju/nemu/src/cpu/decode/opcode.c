...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_0x, add_0x, add_0x, add_0x,
    /* 0x04 - 0x07*/ add_0x, add_0x, inv, inv,
    /* 0x08 - 0x0b*/ or_0x, or_0x, or_0x, or_0x,
    /* 0x0c - 0x0f*/ or_0x, or_0x, inv, opcode_2_byte,
    /* 0x10 - 0x13*/ adc_1x, adc_1x, adc_1x, adc_1x,
    /* 0x14 - 0x17*/ adc_1x, adc_1x, inv, inv,
    /* 0x18 - 0x1b*/ sbb_1x, sbb_1x, sbb_1x, sbb_1x,
    /* 0x1c - 0x1f*/ sbb_1x, sbb_1x, inv, inv,
    /* 0x20 - 0x23*/ and_2x, and_2x, and_2x, and_2x,
    /* 0x24 - 0x27*/ and_2x, and_2x, inv, inv,
    /* 0x28 - 0x2b*/ sub_2x, sub_2x, sub_2x, sub_2x,
    /* 0x2c - 0x2f*/ sub_2x, sub_2x, inv, inv,
    /* 0x30 - 0x33*/ xor_3x, xor_3x, xor_3x, xor_3x,
    /* 0x34 - 0x37*/ xor_3x, xor_3x, inv, inv,
    /* 0x38 - 0x3b*/ cmp_3x, cmp_3x, cmp_3x, cmp_3x,
    /* 0x3c - 0x3f*/ cmp_3x, cmp_3x, inv, inv,
    /* 0x40 - 0x43*/ inc_4x, inc_4x, inc_4x, inc_4x,
    /* 0x44 - 0x47*/ inc_4x, inc_4x, inc_4x, inc_4x,
    /* 0x48 - 0x4b*/ dec_4x, dec_4x, dec_4x, dec_4x,
    /* 0x4c - 0x4f*/ dec_4x, dec_4x, dec_4x, dec_4x,
    /* 0x50 - 0x53*/ push_5x, push_5x, push_5x, push_5x,
    /* 0x54 - 0x57*/ push_5x, push_5x, push_5x, push_5x,
    /* 0x58 - 0x5b*/ pop_5x, pop_5x, pop_5x, pop_5x,
    /* 0x5c - 0x5f*/ pop_5x, pop_5x, pop_5x, pop_5x,
    /* 0x60 - 0x63*/ pusha, popa, inv, inv,
    /* 0x64 - 0x67*/ inv, inv, data_size_16, inv,
    /* 0x68 - 0x6b*/ push_68, imul_irm2r_v, push_6a, imul_i8rm2r_v,
    ...
    /* 0xe8 - 0xeb*/ call_e8, jmp_near, jmp_ea, jmp_eb,
    /* 0xec - 0xef*/ in_ec, in_ed, out_ee, inv,
...
instr_func group_1_b_entry[8] =
    {add_grp1, or_grp1, adc_grp1, sbb_grp1, and_grp1, sub_grp1, xor_grp1, cmp_grp1};
...
instr_func group_3_b_entry[8] =
    {test_f6_0, inv, not_f6_2, neg_f6_3, mul_rm2a_b, imul_rm2a_b, div_rm2a_b, idiv_rm2a_b};

/* 0xf7 */
instr_func group_3_v_entry[8] =
    {test_f7_0, inv, not_f7_2, neg_f7_3, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v};

/* 0xff */
instr_func group_5_indirect_entry[8] =
    {inc_ff_0, dec_ff_1, call_ff_2, inv, jmp_ff_4, inv, push_ff_6, inv};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ mov_0f20, inv, mov_0f22, inv,
